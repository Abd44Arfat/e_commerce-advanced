...
class _$ErrorAuthStateImpl implements ErrorAuthState {
  const _$ErrorAuthStateImpl({required this.error});
...
abstract class ErrorAuthState implements AuthState {
  const factory ErrorAuthState({required final String error}) =
...
class _$SuccessAuthStateImpl implements SuccessAuthState {
  const _$SuccessAuthStateImpl({required this.userRole});
...
abstract class SuccessAuthState implements AuthState {
  const factory SuccessAuthState({required final String userRole}) =
